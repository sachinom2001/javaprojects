        ...
        do {
            ...
            switch (option){
                ...
                case 4 :
                    ...
                    String appl5=softwareHub.getApplicationNameByType(sc.next());
                    System.out.println(appl5);
                    break;

                case 5 :
                    System.out.println("Enter the Name of an application : ");
                    String appl6=softwareHub.getApplicationTypeByName(sc.next());
                    System.out.println(appl6);
                    break;

                case 6 :
                    System.out.println("Enter the type of an application : ");
                    String appl7=softwareHub.getApplicationSizeByType(sc.next());
                    System.out.println(appl7);
                    break;

                case 7 :
                    System.out.println("Enter the Type of an application : ");
                    double appl8=softwareHub.getApplicationVersionByType(sc.next());
                    System.out.println(appl8);
                    break;

                case 8 :
                    System.out.println("Enter the Version of an application : ");
                    int appl9=softwareHub.getApplicationReleaseDateByVersion(sc.nextDouble());
                    System.out.println(appl9);
                    break;

                case 9 :
                    System.out.println("Enter the application name : ");
                    System.out.println("Enter the Version to be update : ");
                    boolean appl10=softwareHub.updateApplicationVersionByAppName(sc.next(),sc.nextDouble());
                    softwareHub.getAllApplication();
                    break;
                ...
                case 10 :
                    ...
                    boolean apll11=softwareHub.updatedApplicationCompanyNameById(sc.nextInt(), sc.next());
                    softwareHub.getAllApplication();
                    break;
